...
.green-500 {
    background-color: #03df5f; /* لون أخضر */
    color: white;
    padding: 5px 10px;
    border-radius: 25px;
}
...
.gray-500 {
    background-color: #a0aec0; /* لون رمادي */
    color: white;
    padding: 5px 10px;
    border-radius: 25px;
}
...
.status-indicator {
    position: absolute;
    bottom: 10px; /* المسافة من أسفل الصورة */
    right: 10px;  /* المسافة من يمين الصورة */
    width: 15px;
    height: 15px;
    border-radius: 50%;
    border: 2px solid white; /* لإضافة حدود بيضاء حول الدائرة */
}

/* الألوان للحالات المختلفة */
.status-indicator.Online {
    background-color: #48bb78; /* أخضر للحالة النشطة */
}

.status-indicator.Offline {
    background-color: #f56565; /* أحمر للحالة الخاملة */
}

.status-indicator.unknown {
    background-color: #a0aec0; /* رمادي للحالة غير المعروفة */
}
        ...
        <section class="user-info-section">
            ...
            <div class="immg" style="position: relative; width: 30%; margin: auto;">
                <img src="{{ asset('storage/'.$user->profile_photo_path) }}"
                     style="width: 100%; max-height:100px; margin-bottom:5px; border-radius:50%;"
                     alt="">
