...
<div class="container mt-5">
    <div class="course-container border rounded shadow-sm p-4 bg-light">
        <!-- Course Header -->
        ...
        <div class="course-details">
            <!-- Description -->
            <div class="course-section mb-3 p-3 bg-white rounded shadow-sm">
                ...
                <ul class="list-group">
                    @foreach($sections as $section)
                        <li class="list-group-item">
                            <button class="btn btn-link toggle-section" style="color: black" data-target="section-{{ $loop->iteration }}">
