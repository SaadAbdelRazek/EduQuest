                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="{{ route('contacts.store') }}" method="POST" class="form-contact contact_form">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input class="form-control" name="name" id="name" type="text"
                                                placeholder="Enter your name" value="{{ $user_data->name }}" readonly
                                                hidden>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input class="form-control" name="email" id="email" type="email"
                                                placeholder="Email" value="{{ $user_data->email }}" readonly hidden>
                                            @if ($errors->has('email'))
                            ...
                            <div id="successMessage"
                                ...
                                <i id="close" class="fas fa-check-circle" style="margin-right: 10px; font-size: 20px; cursor:pointer;"></i>
