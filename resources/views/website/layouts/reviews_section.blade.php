...
<section class="student-reviews">
    ...
    <form action="{{ route('sub_review', $course->id) }}" method="POST" class="review-form">
        ...
        <!-- حقل التقييم -->
        <input type="hidden" name="instructor_id" value="{{ $instructor->user_id }}"> <!-- تأكد من تمرير معرف المدرب هنا -->
    ...
    <!-- زر Show More للانتقال إلى صفحة معلومات المدرب -->
    {{-- <a href="{{ route('instructor.details', $instructor->id) }}" class="show-more-btn">Show More</a> --}}
